...
import com.nova.infra.adapter.in.network.packets.incoming.misc.ResetResolutionAchievementMessageEvent;
...
public class ResetResolutionAchievementParser extends PacketParser<ResetResolutionAchievementMessageEvent> {
    ...
    public int getHeaderId() {
        return Incoming.RESETRESOLUTIONACHIEVEMENTMESSAGE;
    }
